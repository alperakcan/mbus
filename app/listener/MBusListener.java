...
public class MBusListener {
	public static void main (String[] args) throws IOException {
		if (args.length != 2) {
			System.err.println("Usage: java MBusListener <host name> <port number>");
			System.exit(1);
		}
		...
		try (
			...
			while (true) {
				...
				System.out.println("read responseBufferLength: " + responseBufferLength + ", responseBufferSize: " + responseBufferSize);
				...
				while (true) {
					...
					System.out.println("  expected: " + expected + ", responseString: " + responseString);
